...
import dinino.marc.games.userflow.common.ui.route.GameRoute
import dinino.marc.games.userflow.tictactoe.di.TicTacToeUserFlowProviders
import kotlinx.serialization.Serializable
import org.koin.mp.KoinPlatform

@Serializable
data class TicTacToeGameRoute(override val newGame: Boolean) : ContentWithAppBarScreenRoute(), GameRoute {
